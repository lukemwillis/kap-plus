import { useColorModeValue, Icon, ResponsiveValue } from "@chakra-ui/react";
    ...
    >
      <g id="Shadow">
        <g>
          <polygon
            fill={fill}
            points="104.687,129.11 113.291,138.4 158.395,88.217 141.441,88.217 		"
          />
          <polygon
            fill={fill}
            points="76.657,114.179 85.657,104.136 85.657,47.201 76.657,47.201 		"
          />
          <polygon
            fill={fill}
            points="157.385,187.467 124.325,187.467 130.774,194.467 163.869,194.467 		"
          />
          <polygon
            fill={fill}
            points="76.657,143.182 76.657,187.467 58.997,187.467 58.997,194.467 85.657,194.467 85.657,152.951 		
        "
          />
        </g>
        <g>
          <path
            fill={fill}
            d="M199.311,155.59c-1.872-4.233-2.814-9.014-2.814-14.346c0-9.115,2.726-16.585,8.176-22.413
        ...
        c0,8.47,2.457,15.21,7.51,20.605C196.365,153.301,197.8,154.542,199.311,155.59z"
          ...
          <polygon
            fill={fill}
            points="270.895,88.217 270.895,187.467 253.235,187.467 253.235,194.467 279.895,194.467 279.895,88.217 
            "
          />
          <path
            fill={fill}
            d="M238.235,187.467v-7.665c-3.812,2.986-7.663,5.297-11.501,6.896c-5.583,2.325-11.697,3.503-18.176,3.503
        ...
        <g>
          <path
            fill={fill}
            d="M349.34,103.092c-7.62,0-13.75,2.512-18.741,7.678c-5.019,5.196-7.458,11.861-7.458,20.377
        ...
        C362.8,105.59,356.795,103.092,349.34,103.092z"
          ...
          <path
            fill={fill}
            d="M324.313,179.794v46.54h-17.465v7h26.465v-47.809C330.3,184.035,327.292,182.123,324.313,179.794z"
          />
          <path
            fill={fill}
            d="M402.259,101.205c-0.975-1.052-1.975-2.038-2.991-2.984c5.672,9.415,8.542,20.573,8.542,33.317
        ...
        <path
          fill={fill}
          d="M471.117,87.711c1.121,2.881,1.743,6.01,1.743,9.283c0,14.159-11.519,25.677-25.678,25.677
      ...
      C481.86,98.849,477.564,91.71,471.117,87.711z"
        ...
        <path
          fill={fill}
          d="M471.117,155.712c1.121,2.881,1.743,6.01,1.743,9.282c0,14.158-11.519,25.677-25.678,25.677
      ...
      C481.86,166.85,477.564,159.711,471.117,155.712z"
        ...
        <polygon
          fill={fill}
          points="587.657,47.146 514.182,213.146 493.552,213.146 490.453,220.146 524.229,220.146 600.803,47.146 	
      "
        />
        <polygon
          fill={fill}
          points="660.862,47.146 587.387,213.146 566.757,213.146 563.658,220.146 597.434,220.146 674.008,47.146 	
      "
        />
      </g>
      <g id="Front">
        <g>
          ...
          <polygon
            fill={fill}
            points="145.001,181.467 96.564,129.17 139.665,81.217 114.254,81.217 71.587,128.826 120.089,181.467 		
        "
          />
        </g>
        <path
          fill={fill}
          d="M264.895,181.467V81.217h-20.66v16.036l-5.137-5.211c-4.453-4.518-9.352-7.947-14.561-10.19
      ...
      C245.407,141.335,242.347,149.734,236.312,156.11z"
        ...
        <path
          fill={fill}
          d="M388.057,93.243c-9.192-9.932-20.036-14.76-33.15-14.76c-5.938,0-11.585,1.134-16.784,3.369
      ...
      c5.982,6.375,9.016,14.606,9.016,24.466C381.247,141.17,378.164,149.485,372.084,155.956z"
        ...
        <path
          fill={fill}
          d="M447.183,77.316c-10.85,0-19.677,8.828-19.677,19.678s8.827,19.677,19.677,19.677
      c10.851,0,19.678-8.827,19.678-19.677S458.033,77.316,447.183,77.316z"
        />
        <path
          fill={fill}
          d="M447.183,145.317c-10.85,0-19.677,8.827-19.677,19.678c0,10.85,8.827,19.677,19.677,19.677
      c10.851,0,19.678-8.827,19.678-19.677C466.86,154.144,458.033,145.317,447.183,145.317z"
        />
        <polygon
          fill={fill}
          points="556.98,40.146 483.062,207.146 510.275,207.146 584.194,40.146 	"
        />
        <polygon
          fill={fill}
          points="630.186,40.146 556.267,207.146 583.48,207.146 657.399,40.146 	"
        />
      </g>
    </Icon>
  );
